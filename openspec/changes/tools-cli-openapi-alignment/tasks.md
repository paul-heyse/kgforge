...
- [x] 1.1 Scaffold shared tooling module.
...
- [x] 1.4 Align MkDocs CLI diagram tooling.
...
- [x] 2.1 Unit tests for shared module.
...
- [x] 2.2 Update MkDocs diagram tests.
