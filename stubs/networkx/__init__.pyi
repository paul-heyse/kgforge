...
def simple_cycles[NodeType: Hashable](
    graph: DiGraph[NodeType], length_bound: int | None = None
) -> Iterator[list[NodeType]]: ...
def strongly_connected_components[NodeType: Hashable](
    graph: DiGraph[NodeType],
) -> Iterable[list[NodeType]]: ...
def degree_centrality[NodeType: Hashable](graph: DiGraph[NodeType]) -> Mapping[NodeType, float]: ...
