...
CANONICAL_ERROR_CODES: Final[dict[str, CanonicalErrorCode]] = {
    ...
    "KGF-DOC-BLD-005": _code(
        "KGF-DOC-BLD-005",
        title="DocFacts schema generation failed",
        summary="The docstring builder could not regenerate docs/_build/schema_docfacts.json",
        domain="documentation",
        category="build",
        severity="error",
        remediation="Run 'uv run python -m tools.docstring_builder.cli schema' manually and resolve the reported errors.",
    ),
