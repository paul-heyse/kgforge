...
gallery_manifest_module = importlib.import_module("tools.docs.gallery_manifest")
GalleryManifestError = gallery_manifest_module.GalleryManifestError
explicit_order = gallery_manifest_module.explicit_order
load_gallery_manifest = gallery_manifest_module.load_gallery_manifest
...
GALLERY_MANIFEST_PATH = ROOT / "docs" / "gallery" / "manifest.json"
