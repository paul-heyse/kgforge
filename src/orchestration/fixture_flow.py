...
from kgforge.kgforge_common.parquet_io import ParquetVectorWriter, ParquetChunkWriter
...
def t_write_fixture_chunks(chunks_root: str) -> tuple[str, int]:
    ...
    rows = [{
        ...
        "start_char":0,"end_char":28,"doctags_span":{"node_id":"n1","start":0,"end":28},
        "text":"Hello fixture text about LLMs","tokens":5,"created_at":0
    }]
...
def t_register_in_duckdb(db_path: str, chunks_info, dense_info, sparse_info) -> dict:
    ...
    reg.register_documents([Doc(id="urn:doc:fixture:0001", title="Fixture Doc", authors=[], pdf_uri="/dev/null",
                                source="fixture", openalex_id=None, doi=None, arxiv_id=None, pmcid=None,
                                pub_date=None, license="CC0", language="en", content_hash="")])
